...
CREATE TABLE public.products (
    ...
    part_price_usd_cents integer NOT NULL,
...
--
-- Name: products_import_version_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.products_import_version_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
